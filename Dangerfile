...
has_app_changes = !git.modified_files.grep(/Fit Me/).empty?
has_test_changes = !git.modified_files.grep(/Fit MeTests/).empty?
...
is_plist_change = git.modified_files.sort == ["Fit Me/Info.plist"].sort
